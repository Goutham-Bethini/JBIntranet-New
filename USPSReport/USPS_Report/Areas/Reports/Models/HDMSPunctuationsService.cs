...
namespace USPS_Report.Areas.Reports.Models
{
    public class HDMSPunctuationsService
    {
        public List<HDMSPunctuationsVM> GetDetails_Puncuation()
        {
            ...
            {
                records = _db.Database.SqlQuery<HDMSPunctuationsVM>(@"  Select AI.Account,AI.Reference as InsuranceID,AM.First_Name as FirstName,AM.Last_Name as LastName,AM.Sex as Gender,AM.BirthDate,AI.Billable_Party_Member
  ...
  join tbl_Account_Member AM on AM.Account = AI.Account and AM.Member = 1 where AI.InActiveAccount = 0
  ...
  or AM.Sex ='' or (AM.BirthDate > DATEADD(yy,-18,GETDATE()) AND (AI.Billable_Party_Member is null  or AI.Billable_Party_Member = ''))) ").ToList<HDMSPunctuationsVM>();
            }
